...
export class AppComponent {
  ...
  disciplinas = [
    new Disciplina('Língua Portuguesa', 'O objetivo norteador da BNCC de Língua Portuguesa ' +
      ...
      'vista, partilha ou constrói visões de mundo e produz conhecimento.', 123, new Professor ('Luciana Ozelim Cavichioli')),
    new Disciplina('Educação Física', 'A Educação Física é o componente curricular ' +
      ...
      'Logo, as práticas corporais são textos culturais passíveis de leitura e produção.', 124, new Professor('Milton Cavichioli Junior')),
    new Disciplina('Inglês', 'Aprender a língua inglesa propicia a criação de novas ' +
      ...
      'qual as dimensões pedagógicas e políticas são intrinsecamente ligadas.', 125, new Professor('Giovanni Ozelim Cavichioli')),
    new Disciplina('Matemática', 'No Ensino Fundamental, essa área, por meio da ' +
      ...
      'podem ser estimuladas, sobretudo ao final do Ensino Fundamental.', 126, new Professor('Andressa Juliane Stragliotto')),
    new Disciplina('Ciências', 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
      ...
      'expliquem e intervenham no mundo em que vivem.', 127, new Professor('Emilly Oliveira Blatt')),
  ];
